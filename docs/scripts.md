...
| `fm-flux-skills-verify.sh` | Verify the pinned `fluxcd/agent-skills` vendor tree against MANIFEST and checksums without network |
| `fm-flux-skills-vendor.sh` | Maintainer refresh of the adopted Flux CD agent skills vendor tree from a verified upstream tag |
